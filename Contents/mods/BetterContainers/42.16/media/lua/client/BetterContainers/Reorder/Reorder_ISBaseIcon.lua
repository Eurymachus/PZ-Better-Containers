local Reorder_ISBaseIcon = {}

Reorder_ISBaseIcon.install = function()
    -- Applies the reordering of backpacks to the context menu of ISBaseIcon
    local _doContextMenu = ISBaseIcon.doContextMenu
    ISBaseIcon.doContextMenu = function(self, _context)
        ...
        if playerInv then
            ...
            for i = 1, #bpList do
                originalOrder[i] = bpList and bpList[i] or nil
            end
        ...
        local retVal = _doContextMenu(self, _context)
