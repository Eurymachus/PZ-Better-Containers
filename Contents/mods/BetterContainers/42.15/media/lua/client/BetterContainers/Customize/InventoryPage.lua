            ...
            for _, btn in ipairs(self.backpacks or {}) do
                if btn and btn.inventory then
                    ...
                    if parent and not isCorpse then
                         -- Vanilla has just assigned the button's current row visuals.
                        -- Force-refresh our cached base state from those visuals before
                        -- applying any BetterContainers customization.
                        Customizer.captureBaseVisuals(btn, true)
